   ...
   <>
     <div class="main">
       ...
       <div class="name">
           ...
           <br/>
           <input type="text" id="name" name="name" value={finput.name} placeholder="Enter your name" required/>
       </div>
       <br/>
       <div class="address"/>
           <label>Address: </label>
           <br/>
           <input type="text" name="address" value={finput.address}  placeholder="Enter your Address" id="address"/>
       <div/>
       <br/>
       <div class="gender">
           <label>Gender: </label>
       ...
       <div class="phone">
           ...
           <br/>
           <input type="number" name="phoneno" value={finput.phoneno} placeholder="Enter your phone no" id="phone" required />
       </div>
       <br />
       <div class="email">
           <label>Email Id: </label>
           <br/>
           <input type="email" name="email" value={finput.email} placeholder="Enter your Email Id" required/>
       </div>
       <br/>
       <div>
           {/* <!-- <div class="pass"> --> */}
       ...
       {/* <!-- </div> --> */}
           <br/>
           <input type="text" name="password" value={finput.password} id="password" placeholder="Enter your password" required />
           <br/>
